package com.example.toolkit.sample.aop.aspect;

import com.example.toolkit.sample.aop.annotation.MyLog;
...
public class LogAspect {
     ...
     * execution(* set*(..))
     * <p>
     * 3、com.example.toolkit.sample.aop.biz.testController这个类里的所有的方法
     * execution(* com.example.toolkit.sample.aop.biz.testController.* (..))
     * <p>
     * 4、com.example.toolkit.sample.aop.biz包下的所有的类的所有的方法
     * execution(* com.example.toolkit.sample.aop.biz.*.*(..))
     * <p>
     * 5、com.example.toolkit.sample.aop.biz包及子包下所有的类的所有的方法
     * execution(* com.example.toolkit.sample.aop.biz..*.*(..))
     * <p>
     * 6、com.example.toolkit.sample.aop.biz包及子包下所有的类的有三个参数，
     * 第一个参数为String类型，第二个参数为任意类型，第三个参数为Long类型的方法
     * <p>
     * @Pointcut("execution(* com.example.toolkit.sample.aop.biz..*.*(String,*,Long))")
     * <p>
     * 7、任何标注了MyLog注解的目标类方法
     * @Pointcut("@annotation(com.example.toolkit.sample.aop.annotation.MyLog)")
     */
    @Pointcut("@annotation(com.example.toolkit.sample.aop.annotation.MyLog)")
